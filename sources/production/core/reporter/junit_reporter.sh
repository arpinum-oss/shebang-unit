...
function junit_reporter__test_ends_running() {
  ...
  _junit_reporter__flush_all_test_outputs_to_report_if_any
...
function _junit_reporter__flush_all_test_outputs_to_report_if_any() {
  _junit_reporter__flush_test_outputs_to_report_if_any "standard"
  _junit_reporter__flush_test_outputs_to_report_if_any "error"
}

function _junit_reporter__flush_test_outputs_to_report_if_any() {
  local outputs_type=$1
  local key="sbu_current_test_${outputs_type}_ouputs_lines"

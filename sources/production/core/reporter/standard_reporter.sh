function standard_reporter__tests_files_end_running() {
	...
	_reporter__print_with_color "${green_tests}, ${red_tests} ${time}" "${color}"
}
...
function standard_reporter__test_has_succeeded() {
  _reporter__print_with_color "OK" ${SBU_GREEN_COLOR_CODE}
}

function standard_reporter__test_has_failed() {
  _reporter__print_with_color "KO" ${SBU_RED_COLOR_CODE}
}
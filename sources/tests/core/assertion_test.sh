...
asserting_that_successful_command_has_success_status_code_is_true() {
...
asserting_that_failing_command_has_success_status_code_is_false() {
...
can_print_custom_message_for_success_status_code_assertion() {
...
asserting_that_failing_command_has_failure_status_code_is_true() {
...
asserting_that_successful_command_has_failure_status_code_is_false() {
...
can_print_custom_message_for_failure_status_code_assertion() {
...
asserting_that_successful_command_is_successful_is_true() {
...
arguments_are_provided_for_successful_assertion() {
...
arguments_with_spaces_are_provided_for_successful_assertion() {
  message="$(assertion__successful \
...
asserting_that_failing_command_is_successful_is_false() {
...
asserting_that_failing_command_is_failing_is_true() {
...
arguments_with_spaces_are_provided_for_failing_assertion() {
...
asserting_that_successful_command_is_failing_is_false() {
...
asserting_that_equal_objects_are_equal_is_true() {
...
asserting_that_different_objects_are_equal_is_false() {
...
assertion_messages_are_printed_with_special_characters() {
...
asserting_that_different_objects_are_different_is_true() {
...
asserting_that_equal_objects_are_different_is_false() {
...
asserting_that_string_contains_substring_is_true() {
...
asserting_that_string_contains_different_string_is_false() {
...
asserting_that_string_does_not_contain_different_string_is_true() {
...
asserting_that_string_does_not_contain_substring_is_false() {
...
asserting_that_empty_string_is_empty_is_true() {
...
asserting_that_not_empty_string_is_empty_is_false() {
...
asserting_that_not_empty_string_is_not_empty_is_true() {
...
asserting_that_empty_string_is_not_empty_is_false() {
...
asserting_that_array_contains_contained_element_is_true() {
...
asserting_that_array_contains_not_contained_element_is_false() {
  local array=("a" "the element" "c")
...
asserting_that_array_does_not_contain_not_contained_element_is_true() {
  local array=("a" "b" "c")
...
asserting_that_array_does_not_contain_contained_element_is_false() {
  local array=("a" "the element" "c")
...
_successful_command_for_2_arguments() {
  (( $# == 2 ))
}

_failing_command_for_2_arguments() {
  (( $# != 2 ))
}
